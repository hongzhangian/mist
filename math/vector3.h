...
#ifndef MIST_MATH_VECTOR3_H_
#define MIST_MATH_VECTOR3_H_
...
class Vector3 {
 ...
 public:
  ...
  inline friend Vector3 operator*(const Real fScalar, const Vector3& rkVector) {
    return Vector3(fScalar * rkVector.x,
                   fScalar * rkVector.y,
                   fScalar * rkVector.z);
  }
  ...
  inline bool positionEquals(
      const Vector3& rhs, Real tolerance = 1e-03) const {
  ...
  inline bool positionCloses(
      const Vector3& rhs, Real tolerance = 1e-03f) const {
